...
set shortmess=aoO
badd +1 BCMCommunication.c
badd +0 BCM.h
badd +1 o.
badd +0 BCMCommunication.h
badd +0 BCMProc.c
argglobal
silent! argdel *
argadd BCMCommunication.c
edit BCMProc.c
...
silent! normal! zE
let s:l = 189 - ((0 * winheight(0) + 12) / 25)
...
wincmd w
argglobal
edit ~/Documents/BCM-ioc-epics/BCMApp/src/BCMCommunication.h
nnoremap <buffer> <silent> - :CCTreeRecurseDepthMinus
nnoremap <buffer> <silent> = :CCTreeRecurseDepthPlus
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
edit ~/Documents/BCM-ioc-epics/BCMApp/src/BCM.h
nnoremap <buffer> <silent> - :CCTreeRecurseDepthMinus
nnoremap <buffer> <silent> = :CCTreeRecurseDepthPlus
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
edit ~/Documents/BCM-ioc-epics/BCMApp/src/BCMCommunication.c
nnoremap <buffer> <silent> - :CCTreeRecurseDepthMinus
nnoremap <buffer> <silent> = :CCTreeRecurseDepthPlus
setlocal keymap=
setlocal noarabic
